    ...
    ipConfigurations: [
      {
        ...
        properties: {
          subnet: { id: Firewall_vnet.properties.subnets[0].id }
          publicIPAddress: { id: Firewall_publicIp.id }
        }
      }
    ]
  }
...
resource Azure_Firewall 'Microsoft.Network/azureFirewalls@2023-11-01' = {
  ...
  properties: {
    ...
    firewallPolicy: { id: Azure_Firewall_policy.id }
    ipConfigurations: [
      {
        name: 'azureFirewallIpConfig'
        properties: {
          subnet: { id: Azure_Firewall_vnet.properties.subnets[0].id }
          publicIPAddress: { id: Azure_Firewall_publicIp.id }
        }
      }
    ]
  }
