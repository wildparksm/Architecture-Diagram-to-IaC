...
from adapters.drawio_adapter import DrawioAdapter
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Generate raw evidence from draw.io XML source")
    parser.add_argument("--input", required=True, help="Path to draw.io XML file")
...
def main() -> int:
    ...
    adapter = DrawioAdapter(run_id=run_id)
