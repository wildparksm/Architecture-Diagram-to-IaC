...
var deferredAzureResources = [
  ...
  }
  {
    ...
    category: 'azure.networkBundle'
    note: 'Requires decomposition into VNet, Subnet, NSG, and Route Table resources'
  }
  {
    name: 'Azure-Firewall'
    category: 'azure.firewall'
  ...
  }
  {
    ...
    category: 'azure.avdBundle'
    note: 'Requires decomposition into Workspace, Host Pool, and Application Group resources'
  }
]
...
// Suggested decomposition for deferred bundle: VNet / Subnet / NSG / Route Table
...
// Suggested decomposition for deferred bundle: AVD Workspace / Host Pool / App Group
...
// }
//
// resource avdAppGroup 'Microsoft.DesktopVirtualization/applicationGroups@2024-04-03' = {
